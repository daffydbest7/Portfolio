        ...
        <div className="w-full h-screen bg-gradient-to-b  p-4 text-white dark:bg-gradient-to-t from-black/80 to-black/100 dark:text-gray-300" name="contact">
            <div className="flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full">
                <div className="pb-8">
                    ...
                    <p className="py-6 text-md lg:text-xl">Wondering How to get in touch? Submit the form below, I respond swiftly...</p>
                </div>
                ...
                className="flex justify-center items-center">
                    <form action="https://getform.io/f/3edaa17c-e0e6-4cd4-806c-eb3700a415f7" method="POST" className="flex flex-col w-full md:w-1/2">
                        <input type="text" name="name" placeholder="David Lawrence ..." 
                        ...
                        <input type="email" name="email" placeholder="daffydbest@gmail.com" 
                        ...
                        <button className="group text-white hover:outline hover:outline-teal-500 px-4 py-2 lg:px-6 lg:py-3 my-8 mx-auto flex items-center rounded-md hover:scale-105 duration-300 text-md lg:text-lg">
                            DM <BiWinkSmile className="ml-2 text-2xl lg:text-3xl text-yellow-200 group-hover:text-pink-600 animate-bounce"/></button>
                    </form>
                </motion.div>
            </div>
        </div>
