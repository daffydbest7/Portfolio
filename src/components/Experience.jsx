...
const Experience =() =>{
    ...
    return (
        <div name="experience" className="  mx-auto h-screen  w-full dark:bg-gradient-to-t from-black to-black dark:text-gray-300">
            <div className="max-w-screen-lg mx-auto p-4 flex flex-col justify-center w-full h-full ">
                ...
                <motion.div variants={fadeIn('right', 0.4)} initial="hidden" whileInView={'show'} viewport={{once:false, amount:0.8}}
